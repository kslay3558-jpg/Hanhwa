...
(() => {
  ...
  const I18N = {
    ko: {
      ...
      'tut.s5_t':             '5. 파이프 커팅 계산기',
      'tut.s5_d':             '상단 ✂️ 아이콘을 누르면 파이프 사선 커팅 계산기로 이동합니다.',
    ...
    vi: {
      ...
      'tut.s5_t':             '5. Máy tính cắt ống',
      'tut.s5_d':             'Nhấn biểu tượng ✂️ ở thanh trên để chuyển sang máy tính cắt chéo ống.',
    ...
    id: {
      ...
      'tut.s5_t':             '5. Kalkulator potong pipa',
      'tut.s5_d':             'Tekan ikon ✂️ di bagian atas untuk pindah ke kalkulator potong miring pipa.',
